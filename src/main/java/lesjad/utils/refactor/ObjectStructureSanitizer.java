...
/**
 * Modifies given Object according Map of conditions.
...
public interface ObjectStructureSanitizer {
     ...
     * @param modificationsMap pair of {@link Predicate} and {@link Consumer}.
     *                 if <B>Object o</B> meets <B>Predicate</B> perform operation on it described in <B>Function</B>
     * @return refactored Object o;
     */
    Object refactorObject(Object o, Predicate<Object> nestingLimit, Map<Predicate<Object>, Consumer<Object>> modificationsMap);
}